...
const Component: React.FC<IProps> = ({
  ...
  <div className={className}>
    ...
    <div className="col">
      ...
      <a
        href={`https://twitter.com/intent/tweet?text=${title}%0ahttps://blog.nunusuke.io${path}`}
        target="_blank"
      ...
      <a
        href="http://www.facebook.com/share.php?u=https://blog.nunusuke.io"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href={`https://github.com/sadnessOjisan/blog.nunusuke.io/blob/master/src/contents/${dateYYYYMMDD}-${path.replace(
          "/",
          ""
        )}`}
        target="_blank"
